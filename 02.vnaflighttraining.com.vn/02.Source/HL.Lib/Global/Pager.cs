namespace HL.Lib.Global
{
    public class Pager
    {
        ...
        private string _BackText = "<span>&lt;</span>";
        private string _NextText = "<span>&gt;</span>";
        private string _BackEndText = "<span>&laquo;</span>";
        private string _NextEndText = "<span>&raquo;</span>";
        ...
        public void Update()
        {
            ...
            else
            {
                ...
                if (MaxPageIndex > 1)
                {
                    _HtmlPage += "<nav><ul class=\"pagination\">";
                    if (MaxPage > _PageMax)
                    {
                        _HtmlPage += "<li class=\"page-item\"><a class=\"page-link\" href=\"" + sURL + "/" + 1 + "\">" + BackEndText + "</a></li>";
                        _HtmlPage += "<li class=\"page-item\"><a class=\"page-link\" href=\"" + sURL + "/" + MinPage + "\">" + BackText + "</a></li>";
                    }
                    else if (DisableMode)
                    {
                        _HtmlPage += "<li class=\"page-item disabled " + CssClass + "\"><a class=\"page-link\" href=\"#\">" + BackEndText + "</a></li>";
                        _HtmlPage += "<li class=\"page-item disabled " + CssClass + "\"><a class=\"page-link\" href=\"#\">" + BackText + "</a></li>";
                    }
                    ...
                    for (int i = MinPage; i < MaxPage; i++)
                    {
                        if (i != _PageIndex)
                        {
                            if (i < MaxPageIndex)
                            {
                                _HtmlPage += "<li class=\"page-item\"><a class=\"page-link\" href=\"" + sURL + "/" + (i + 1) + "\">" + (i + 1) + "</a></li>";
                            }
                        }
                        else
                        {
                            if (i < MaxPageIndex) _HtmlPage += "<li class=\"page-item active\"><a class=\"page-link" + CssClass + "\" href=\"#\">" + (i + 1) + "</a></li>";
                        }
                    }

                    if (MaxPage < MaxPageIndex)
                    {
                        _HtmlPage += "<li class=\"page-item\"><a class=\"page-link\" href=\"" + sURL + "/" + (MaxPage + 1) + "\">" + NextText + "</a></li>";
                        _HtmlPage += "<li class=\"page-item\"><a class=\"page-link\" href=\"" + sURL + "/" + (MaxPageIndex > (int)MaxPageIndex ? (int)MaxPageIndex + 1 : MaxPageIndex) + "\">" + NextEndText + "</a></li>";
                    }
                    else if (DisableMode)
                    {
                        _HtmlPage += "<li class=\"page-item " + CssClass + " disabled\"><a class=\"page-link\" href=\"#\">" + NextText + "</a></li>";
                        _HtmlPage += "<li class=\"page-item " + CssClass + " disabled\"><a class=\"page-link\" href=\"#\">" + NextEndText + "</a></li>";
                    }
                    _HtmlPage += "</ul></nav>";
                }
