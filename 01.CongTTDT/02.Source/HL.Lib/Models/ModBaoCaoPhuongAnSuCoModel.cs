...
{
    public class ModBaoCaoPhuongAnSuCoEntity : EntityBase
    {
        #region Code by NQT
    ...
    public class ModBaoCaoPhuongAnSuCoService : ServiceBase<ModBaoCaoPhuongAnSuCoEntity>
    {

        #region Code by NQT

        private ModBaoCaoPhuongAnSuCoService()
            : base("[Mod_BaoCaoPhuongAnSuCo]")
        {

        }

        private static ModBaoCaoPhuongAnSuCoService _Instance = null;
        public static ModBaoCaoPhuongAnSuCoService Instance
        {
            get
            {
                if (_Instance == null)
                    _Instance = new ModBaoCaoPhuongAnSuCoService();
        ...
        public ModBaoCaoPhuongAnSuCoEntity GetByID(int id)
        {
