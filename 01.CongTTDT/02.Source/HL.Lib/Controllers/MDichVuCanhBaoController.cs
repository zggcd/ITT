...
{
    public class MDichVuCanhBaoController : Controller
    {
        ...
        public void ActionIndex(MDichVuCanhBaoModel model)
        {
        ...
        {
            var entity = ModDichVuCanhBaoService.Instance.CreateQuery()
            ...
            if (entity != null)
            {
                ViewBag.Other = ModDichVuCanhBaoService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MDichVuCanhBaoModel
    {
        private int _Page = 0;
        public int Page
        {
