...
{
    public class MDichVuCanhBaoIPController : Controller
    {
        ...
        public void ActionIndex(MDichVuCanhBaoIPModel model)
        {
        ...
        {
            var entity = ModDichVuCanhBaoIPService.Instance.CreateQuery()
                            .Where(o => o.Activity == true && o.ID == id)
                            .ToSingle();

            if (entity != null)
            {
                ViewBag.Other = ModDichVuCanhBaoIPService.Instance.CreateQuery()
                                        .Where(o => o.Activity == true)
    ...
    public class MDichVuCanhBaoIPModel
    {
        private int _Page = 0;
        public int Page
        {
