...
{
    public class FormBaoCaoBanDauSuCoController : CPController
    {
        public FormBaoCaoBanDauSuCoController()
        {
            //khoi tao Service
        ...
        public void ActionApply(FormBaoCaoBanDauSuCoModel model, MInfoMagicModelForm modelInfo, MAppendForm append)
        {
            if (ValidSave(model, modelInfo, append))
    ...
    public class FormBaoCaoBanDauSuCoModel : DefaultModel
    {
    ...
    public class MInfoMagicModelForm
    {
