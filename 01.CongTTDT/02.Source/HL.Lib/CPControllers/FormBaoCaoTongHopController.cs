...
{
    public class FormBaoCaoTongHopController : CPController
    {
        public FormBaoCaoTongHopController()
        {
            //khoi tao Service
        ...
        public void ActionIndex(FormBaoCaoTongHopModel model)
        {
            // sap xep tu dong
        ...
        public void ActionAdd(FormBaoCaoTongHopModel model)
        {
            if (model.RecordID > 0)
            {
        ...
        public void ActionSaveNew(FormBaoCaoTongHopModel model, MSoLuongSuCoModelForm entitySuCo)
        {
            if (ValidSave(model, entitySuCo))
        ...
        private int GetMaxOrder(FormBaoCaoTongHopModel model)
        {
    ...
    public class FormBaoCaoTongHopModel : DefaultModel
    {
    ...
    public class MSoLuongSuCoModelForm
    {
