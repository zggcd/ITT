...
<script runat="server">
    ...
    public Permissions Permissions
    {
        get
        {
            ...
            try
            {
                string suser = Request.QueryString[HL.Core.Web.Setting.Sys_SiteID + "_CP.UserID"].Replace(" ", "+");
                string IP = HttpContext.Current.Request.UserHostAddress;
                string suserid = HL.Core.Global.CryptoString.Decrypt(suser).Replace(IP + "_HL_" + HL.Core.Web.Setting.Sys_SiteID + "_CP.UserID", string.Empty);
                int _UserID = HL.Core.Global.Convert.ToInt(suserid);
    ...
    public override void SetConfig()
    {
        ...
        //LicenseName = "";
        //LicenseKey = "";
        //LicenseName = "Le Hoang Anh";
        //LicenseKey = "L1HDYU96UG6TWB21NWUHJ4LTPGYLC61G";
        LicenseName = "lehoanganhhd@gmail.com";
        LicenseKey = "5CUA4LUHRGLWWH6DEYLEF2UT2Q4XYG7D";
