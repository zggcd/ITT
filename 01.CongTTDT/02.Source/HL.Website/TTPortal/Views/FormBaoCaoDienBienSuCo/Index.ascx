...
<%
    var model = ViewBag.Model as FormBaoCaoDienBienSuCoModel;
    var listEntity = ViewBag.Data as List<ModBaoCaoDienBienSuCoEntity>;
%>
...
<form id="hlForm" name="hlForm" method="post">
    ...
    <script type="text/javascript">
        ...
        var HLController = 'FormBaoCaoDienBienSuCo';
