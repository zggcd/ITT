                ...
                <td nowrap="nowrap">
                   Chuyên mục : 
                    <select id="filter_menu" onchange="HLRedirect()" class="inputbox" size="1">
                         ...
                         <%= Utils.ShowDDLMenuByType("HeThongThongTin", model.LangID, model.MenuID)%> 
                    </select>
                   Vị trí :
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th width="1%" nowrap="nowrap">
                        <%= GetSortLink("H s thanh vien u c s c", "HSThanhVienUCSC")%>
                    </th>
                    <th width="1%" nowrap="nowrap">
            ...
            <tbody>
               <%for (int i = 0; listEntity != null && i < listEntity.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                       <%= string.Format("{0:#,##0}", listEntity[i].HSThanhVienUCSC)%>
                    </td>
                    <td align="center">
