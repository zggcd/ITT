            ...
            <div class="toolbar-list" id="toolbar">
                <ul style="float: left; padding-right: 15px;">
                    <li id="toolbar-apply" class="button">
                        <%--<a class="toolbar" href="<%=CPViewPage.Request.RawUrl.Replace("Deface.aspx","Export.aspx") %>">
    ...
    <div id="element-box">
        ...
        <div class="m">
            ...
            <table>
                <tr>
                    <td width="100%">
                        ...
                        <p>
                            ...
                            <select id="filter_member" onchange="HLRedirect('Deface')" class="inputbox" size="1">
                        ...
                        <p>
                            ...
                            <select id="filter_isp" onchange="HLRedirect('Deface')" class="inputbox" size="1">
                                <option value="0">(Tất cả)</option>
                ...
                <tr>
                    <td width="100%">
                        <button onclick="HLRedirect('Deface');return false;">Tìm kiếm</button>
                    </td>
                </tr>
            </table>
