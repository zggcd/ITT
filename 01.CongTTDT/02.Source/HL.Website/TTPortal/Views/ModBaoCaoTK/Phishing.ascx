            ...
            <div class="toolbar-list" id="toolbar">
                <ul style="float: left; padding-right: 15px;">
                    <li id="toolbar-apply" class="button">
                        <a class="toolbar" href="javascript: void(0)" onclick="hl_exec_cmd('Export2')">
    ...
    <div id="element-box">
        ...
        <div class="m">
            ...
            <table>
                <tr>
                    <td width="100%">
                        ...
                        <p>
                            ...
                            <select id="filter_member" onchange="HLRedirect('Phishing')" class="inputbox" size="1">
                        ...
                        <p>
                            <span>Tần suất:</span>
                            <select id="filter_phishing" onchange="HLRedirect('Phishing')" class="inputbox" size="1">
                                <option value="0">(Tất cả)</option>
                                <%= Utils.ShowDDLByConfigkey("Mod.PhishingState", model.PhishingState)%>
                            </select>
                        </p>
                    </td>
                    <td nowrap="nowrap">
                ...
                <tr>
                    <td width="100%">
                        <button onclick="HLRedirect('Phishing');return false;">Tìm kiếm</button>
                    </td>
                </tr>
            </table>
