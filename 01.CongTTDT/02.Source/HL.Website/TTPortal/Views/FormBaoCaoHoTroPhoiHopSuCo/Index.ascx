...
<%
    var model = ViewBag.Model as FormBaoCaoHoTroPhoiHopSuCoModel;
    var listEntity = ViewBag.Data as List<ModBaoCaoHoTroPhoiHopSuCoEntity>;
%>
...
<form id="hlForm" name="hlForm" method="post">
    ...
    <script type="text/javascript">
        ...
        var HLController = 'FormBaoCaoHoTroPhoiHopSuCo';
