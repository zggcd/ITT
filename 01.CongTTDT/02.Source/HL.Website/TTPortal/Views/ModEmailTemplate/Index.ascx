...
<%
    ...
    var listEntity = ViewBag.Data as List<ModEmailTemplateEntity>;
%>
...
<script type="text/javascript">
    ...
    var HLController = 'ModEmailTemplate';
                ...
                <td nowrap="nowrap">
                   Chuyên mục : 
                    <select id="filter_menu" onchange="HLRedirect()" class="inputbox" size="1">
                         ...
                         <%= Utils.ShowDDLMenuByType("EmailTemplate", model.LangID, model.MenuID)%> 
                    </select>
