...
<%
    ...
    var listEntity = ViewBag.Data as List<ModDichVuCanhBaoIPEntity>;
%>
...
<script type="text/javascript">
    ...
    var HLController = 'ModDichVuCanhBaoIP';
                ...
                <td nowrap="nowrap">
                   Chuyên mục : 
                    <select id="filter_menu" onchange="HLRedirect()" class="inputbox" size="1">
                         ...
                         <%= Utils.ShowDDLMenuByType("DichVuCanhBaoIP", model.LangID, model.MenuID)%> 
                    </select>
