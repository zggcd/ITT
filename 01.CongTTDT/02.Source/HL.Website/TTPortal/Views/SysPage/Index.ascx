...
<% 
    ...
    var listEntity = ViewBag.Data as List<SysPageEntity>;
 %>
        ...
        <table class="adminlist" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th nowrap="nowrap">
                        <%= GetSortLink("Chức năng", "ControlID")%>
                    </th>
                    <th nowrap="nowrap">
            ...
            <tbody>
               <%for (int i = 0; listEntity != null && i < listEntity.Count; i++)
                ...
                <tr class="row<%= i%2 %>">
                    ...
                    <td align="center">
                       <%= GetName(SysModuleService.Instance.GetByID(listEntity[i].ModuleID)) %>
                    </td>
                    <td align="center">
                       <%= GetName(SysTemplateService.Instance.GetByID(listEntity[i].TemplateID))%>
                    </td>
                    <%} %>
                    <td align="center">
