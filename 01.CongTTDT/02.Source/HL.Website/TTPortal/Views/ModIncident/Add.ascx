    ...
    <div id="toolbar-box">
        ...
        <div class="m">
            ...
            <div class="pagetitle icon-48-generic">
                <h2>Quản lý sự cố : <%=  model.RecordID > 0 ? "Chỉnh sửa" : "Thêm mới"%></h2>
            </div>
            <div class="clr"></div>
        </div>
        <div class="b">
