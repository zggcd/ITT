                        ...
                        <tbody>
                           <%for (int i = 0; listCPModule != null && i < listCPModule.Count; i++)
                            ...
                            <tr class="row<%= i%2 %>">
                                ...
                                <td align="center">
                                    <input name="ArrDelete" value="<%= listCPModule[i].ID%>" <%if((GetAccess(listCPModule[i].ID)&8) == 8){ %>checked="checked"<%} %> <%if((listCPModule[i].Access&8) != 8){ %>disabled="disabled"<%} %> type="checkbox" />
                                </td>
                                <td align="center">
                                    <input name="ArrEdit" value="<%= listCPModule[i].ID%>" <%if((GetAccess(listCPModule[i].ID)&4) == 4){ %>checked="checked"<%} %> <%if((listCPModule[i].Access&4) != 4){ %>disabled="disabled"<%} %> type="checkbox" />
                                </td>
                                <td align="center">
                                    <input name="ArrAdd" value="<%= listCPModule[i].ID%>" <%if((GetAccess(listCPModule[i].ID)&2) == 2){ %>checked="checked"<%} %> <%if((listCPModule[i].Access&2) != 2){ %>disabled="disabled"<%} %> type="checkbox" />
                                </td>
                                <td align="center">
                                    <input name="ArrView" value="<%= listCPModule[i].ID%>" <%if((GetAccess(listCPModule[i].ID)&1) == 1){ %>checked="checked"<%} %> <%if((listCPModule[i].Access&1) != 1){ %>disabled="disabled"<%} %> type="checkbox" />
                                </td>
                                <td>
                                    <%= listCPModule[i].Name%>
                                </td>
