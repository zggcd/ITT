                        ...
                        <div class="box_content_input">
                            ...
                            <div class="button">
                                ...
                                <%}
                                    ...
                                    {%>
                                <input class="btn_action search icon QAcustom" name="_hl_action[AddBCKetThucUCSC]" value="Lưu" type="submit" />
                                <%}%>

                                <input style="margin-left: 10px;" onclick="location.href = '/vn/Thanh-vien/DS-bc-ket-thuc-su-co.aspx';" type="button" name="" value="Danh sách báo cáo" />
                            </div>
