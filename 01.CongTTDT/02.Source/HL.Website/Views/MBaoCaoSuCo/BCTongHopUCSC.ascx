...
<div class="row-fluid titleContainer">
    <span>{RS:Form_BCTongHopHeader}</span>
</div>
                        ...
                        <div class="g-search">
                            <div class="box_content_input">
                                ...
                                <div class="button">
                                    ...
                                    <%if (isEdit == 1)
                                        {%>
                                    <input class="btn btn-success" name="_hl_action[UpdateBCTongHopUCSC]" value="{RS:Form_CapNhatBtn}" type="submit" />
                                    <%}
                                        else
                                        {%>
                                    <input class="btn btn-success" name="_hl_action[AddBCTongHopUCSC]" value="{RS:Form_LuuBtn}" type="submit" />
                                    <%}%>
                                    <%}%>
