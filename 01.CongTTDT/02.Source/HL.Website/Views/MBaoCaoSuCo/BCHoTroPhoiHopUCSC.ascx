...
<%
    ...
    ModBaoCaoHoTroPhoiHopSuCoEntity entityBc = ViewBag.BaoCao as ModBaoCaoHoTroPhoiHopSuCoEntity ?? new ModBaoCaoHoTroPhoiHopSuCoEntity();
    List<ModBaoCaoHoTroPhoiHopSuCoEntity> lstBCHoTroPhoiHop = ViewBag.ListBaoCao as List<ModBaoCaoHoTroPhoiHopSuCoEntity> ?? new List<ModBaoCaoHoTroPhoiHopSuCoEntity>();

    string endCode = ViewBag.EndCode;
%>

<div class="row-fluid titleContainer">
    <span>BÁO CÁO ĐỀ NGHỊ HỖ TRỢ-PHỐI HỢP</span>
</div>
                        ...
                        <div class="g-search">
                            <div class="box_content_input">
                                <div class="WordSection1">
                                    ...
                                    <p class="MsoNormal" align="center" style='margin-top: 6.0pt; text-align: center'>
                                        <a style="cursor: context-menu; text-decoration: none">
                                            <b>
                                                <span lang="VI" style='font-size: 10.0pt; font-family: "Arial",sans-serif'>BÁO CÁO ĐỀ NGHỊ HỖ TRỢ-PHỐI HỢP</span>
                                            </b>
                                        </a>
                                        <b>
                                    ...
                                    <p class="MsoNormal" style='margin-top: 6.0pt'>
                                        <b>
                                            <span lang="VI" style='font-size: 10.0pt; font-family: "Arial",sans-serif'>THÔNG TIN ĐỀ NGHỊ HỖ TRỢ-PHỐI HỢP</span>
                                        </b>
                                    </p>
                                    ...
                                    <table class="MsoNormalTable" border="1" cellspacing="0" cellpadding="0" style='border-collapse: collapse; border: none;'>
                                        ...
                                        <%for (int i = 0; i < lstBCHoTroPhoiHop.Count; i++) %>
                                        <%{%>
                                        <tr>
                                            <td valign="top" style='width: 170.5pt; border: solid windowtext 1.0pt; padding: 0in 0in 0in 0in'>
                                                <p class="MsoNormal" style='margin-top: 6.0pt; text-align: center'>
                                                    <%=string.Format("{0:dd/MM/yyyy}", lstBCHoTroPhoiHop[i].ChiTiet_NgayTao) %> lúc <%=string.Format("{0:HH}", lstBCHoTroPhoiHop[i].ChiTiet_NgayTao) %> giờ <%=string.Format("{0:mm}", lstBCHoTroPhoiHop[i].ChiTiet_NgayTao) %> phút
                                                </p>
                                            </td>
                                            <td colspan="5" valign="top" style='width: 425.55pt; border: solid windowtext 1.0pt; border-left: none; padding: 0in 0in 0in 0in'>
                                                <p class="MsoNormal" style='margin-top: 6.0pt; margin-left: 6.0pt'>
                                                    <%= lstBCHoTroPhoiHop[i].ChiTiet_MoTa %>
                                                </p>
                                            </td>
                                            <td colspan="5" valign="top" class="text-center" style='width: 25.55pt; border: solid windowtext 1.0pt; border-left: none; padding: 0in 0in 0in 0in'>
                                                <p class="MsoNormal" style='margin-top: 6.0pt'>
                                                    <a href="javascript: del('<%=lstBCHoTroPhoiHop[i].ID %>', '<%=endCode%>');">Xóa</a>
                                                    <input class="btn_action search icon QAcustom" name="_hl_action[DeleteBCHoTroPhoiHopUCSC]" id="DeleteBCHoTroPhoiHop" value="Xóa" type="submit" style="display: none;">
                                                </p>
                                            </td>
                                        </tr> 
                                        <%} %>
                                    ...
                                    <div class="clear-20">&nbsp;</div>
                                    <p class="MsoNormal" style='margin-top: 6.0pt'>
                                        <span lang="VI" style='font-size: 10.0pt; font-family: "Arial",sans-serif'>&#9642; Thêm mới đề nghị phối hợp-hỗ trợ</span>
                                    </p>
                                    <p class="MsoNormal" style='margin-top: 6.0pt;'>
                                        <i>
                                ...
                                <div class="button">
                                    ...
                                    <input class="btn btn-success" name="_hl_action[AddBCHoTroPhoiHopUCSC]" value="Thêm mới" type="submit" />
