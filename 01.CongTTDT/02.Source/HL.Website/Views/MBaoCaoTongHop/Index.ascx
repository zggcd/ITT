...
<%
    ...
    int langId = ViewPage.CurrentPage.LangID;
    string themBcThUrl = "/vn/Thanh-vien/Them-bc-tong-hop-su-co.aspx";
    if (langId == 2)
    {
        themBcThUrl = "/en/Member/Them-bc-tong-hop-su-co.aspx";
    }
    ...
    <div class="vanban_right">
        <div class="contents">
            <div class="top">
                ...
                <div class="button">
                    <input style="margin-left: 10px;" class="btn_action search icon QAcustom" onclick="location.href = '<%=themBcThUrl%>';" type="button" name="" value="{RS:Web_ThemMoiBtn}" />
                </div>
