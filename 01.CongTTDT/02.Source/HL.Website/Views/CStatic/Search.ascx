...
<div class="search-container">
    <label style="display: none;" for="search">First name</label>
    <input type="text" name="search" id="search" class="input-search" value="" />
    <a class="btn-search" onclick="searchOfCom()"></a>
</div>
