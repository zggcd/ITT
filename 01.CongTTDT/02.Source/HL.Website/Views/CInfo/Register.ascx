                    ...
                    <div class="g-search">
                        <div class="box_content_input">
                            ...
                            <div class="frm_input no1">
                                ...
                                <div class="input">
                                    <input onkeypress="return pkeypress(event);" name="Phone" maxlength="255" id="Phone" class="" type="text" value="<%=entity.Phone %>">
                                </div>
                            </div>
                            ...
                            <div class="button">
                                <input name="" value="Đăng ký tài khoản" id="Btn_DangKyTaiKhoan" class="btn_action search icon QAcustom" type="submit">
                            </div>
